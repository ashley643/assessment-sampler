    ...
    <AdminShell>
      <div className="max-w-2xl">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl font-semibold text-gray-900">Edit Access Code</h1>
          <div className="flex gap-3">
            ...
            <button type="submit" form="code-form" className="px-4 py-2 bg-[#4a6fa5] text-white text-sm font-medium rounded-lg hover:bg-[#3d5d8f] transition-colors">Save</button>
          </div>
        </div>
        <CodeForm codeId={id} />
      </div>
