...
const DEMO_PANELS: DemoPanel[] = [
  {
    ...
    captions: [
      ...
      { t: 6.0,  text: 'extremely energetic, like bouncing off the walls energetic.' },
      { t: 10.7, text: 'Like super energetic, I was running' },
      { t: 13.5, text: 'around everyone in the classroom.' },
